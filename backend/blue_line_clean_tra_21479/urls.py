"""blue_line_clean_tra_21479 URL Configuration
...
admin.site.site_header = "Blue Line Clean Track"
admin.site.site_title = "Blue Line Clean Track Admin Portal"
admin.site.index_title = "Blue Line Clean Track Admin"

# swagger
api_info = openapi.Info(
    title="Blue Line Clean Track API",
    default_version="v1",
    description="API documentation for Blue Line Clean Track App",
)
